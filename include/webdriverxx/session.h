...
namespace webdriverxx {
	...
	public:
		...
		const Session& SetPermissions(const std::string& name, const std::string& value) const;

		picojson::value GetNetworkConditions() const;

		void DeleteNetworkConditions() const;
		...
		picojson::value SetSinkToUse(const std::string& sinkname) const;
